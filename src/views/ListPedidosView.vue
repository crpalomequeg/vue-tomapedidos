          ...
          <tbody>
              <tr v-for="pedido in getPedidos">
                ...
                <td class="border px-4 py-2">
                  ...
                  <button @click="handleRemovePedido(pedido.id)" class="bg-red-500 hover:bg-red-700 text-white font-bold py-2 px-4 mx-1 rounded">
                    Eliminar
                  </button>
                </td>
              </tr>
              ...
              <DialogPanel class="relative transform overflow-hidden rounded-lg bg-white text-left shadow-xl transition-all sm:my-8 sm:w-full sm:max-w-lg">
                <form @submit.prevent="handleCreatePedido">
                        ...
                        <div>
                            ...
                            <div class="flex">
                              ...
                              <div class="mb-5">
                                ...
                                <button type="button" @click="formPedido.productos.push({id_producto: formPedido.id_producto, cantidad: formPedido.cantidad});formPedido.id_producto='';formPedido.cantidad=''" class="bg-blue-500 hover:bg-blue-700 text-white font-bold py-2 px-4 rounded">
                                  +
                                </button>
                              </div>
                            </div>
                            ...
                            <table class="auto w-full text-sm text-left text-gray-500 dark:text-gray-400">
                              ...
                              <tbody>
                                  <tr v-if="formPedido.productos.length==0">
                  ...
                  <div class="bg-gray-50 px-4 py-3 sm:flex sm:flex-row-reverse sm:px-6">
                    ...
                    <button type="button" class="mt-3 inline-flex w-full justify-center rounded-md bg-white px-3 py-2 text-sm font-semibold text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 hover:bg-gray-50 sm:mt-0 sm:w-auto" @click="showNuevoPedidoModal = false" ref="cancelButtonRef">Cancelar</button>
                  </div>
                </form> 
              </DialogPanel>
            </TransitionChild>
